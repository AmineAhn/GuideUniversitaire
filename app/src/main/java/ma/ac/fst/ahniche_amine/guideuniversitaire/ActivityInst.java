...
public class ActivityInst extends AppCompatActivity 
{
    private RecyclerView recyclerView;
    private InstAdapteur adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbarInst);
        setSupportActionBar(toolbar);

        initCollapsingToolbar();

        recyclerView = (RecyclerView) findViewById(R.id.recycler_viewInst);

        instList = new ArrayList<>();
        remplirInsts();
        adapter = new InstAdapteur(this, instList);

        RecyclerView.LayoutManager mLayoutManager = new GridLayoutManager(this, 2);
        recyclerView.setLayoutManager(mLayoutManager);
        recyclerView.addItemDecoration(new ActivityInst.GridSpacingItemDecoration(2, dpToPx(10), true));
        recyclerView.setItemAnimator(new DefaultItemAnimator());
        recyclerView.setAdapter(adapter);

        fab = findViewById(R.id.fabInst);
    ...
    private void initCollapsingToolbar() {
        final CollapsingToolbarLayout collapsingToolbar =
                (CollapsingToolbarLayout) findViewById(R.id.collapsing_toolbarInst);
        collapsingToolbar.setTitle(" ");
        AppBarLayout appBarLayout = (AppBarLayout) findViewById(R.id.appbarInst);
    ...
    private void remplirInsts() {
        ...
        instList = instDbAdapteur.cursorToInsts(instDbAdapteur.getAllInsts());
    }
    ...
    public void onClickFabInst(View view)
    {
