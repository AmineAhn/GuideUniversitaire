...
public class ActivityUniv extends AppCompatActivity {

    private RecyclerView recyclerView;
    private UnivAdapteur adapter;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbarUniv);
        setSupportActionBar(toolbar);

        initCollapsingToolbar();

        recyclerView = (RecyclerView) findViewById(R.id.recycler_viewUniv);
        fab = findViewById(R.id.fabUniv);

        univList = new ArrayList<>();
        remplirUnivs();
        adapter = new UnivAdapteur(this, univList);
    ...
    private void prepareUnivs() {

        /*UnivDbAdapteur univDbAdapteur = new UnivDbAdapteur(this);
        univList = univDbAdapteur.cursorToUnivs(univDbAdapteur.getAllUnivs());
*/
    ...
    private void remplirUnivs() {
        ...
        UnivDbAdapteur univDbAdapteur = new UnivDbAdapteur(this);
        univList = univDbAdapteur.cursorToUnivs(univDbAdapteur.getAllUnivs());
        Log.d("TAG", "SIZE OF UNIVS IS : " + univList.size());
        //adapter.notifyDataSetChanged();
    }
    ...
    public void onClickFabUniv(View view)
    {
